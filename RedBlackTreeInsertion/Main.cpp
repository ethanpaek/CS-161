//Ethan Oaek; April 19th, 2017; this is the insertion code for a RBT (Red Black Tree)
#include <cstring>
#include <iostream>
#include <fstream>
...
int main(){
  cout << "Welcome to The Red Black Tree (insertion only)!" << endl;
